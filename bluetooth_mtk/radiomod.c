...
sHciScriptElement bt_init_script[] = 
{    
...
#else
// Standalone Chip MT6622, MT6626 (MT661x is phased out)
sHciScriptElement bt_init_script[] = 
{
#ifdef MTK_MT6626
...
#ifdef MTK_MT6626
    if(0xFF == btinit->bt_conf.fields.capId[0]){
        hciCommand.parms[0] = 0x40;
    }
#endif
...
static BtStatus GORMcmd_HCC_Set_ECLK(void)
{
    ...
    hciCommand.parms[2] = 0x00;
    hciCommand.parms[3] = 0x80;
    hciCommand.parms[4] = ((bt_conf.fields.ECLK_SEL[0] & 0x1) << 0x1) | 0x1;   /*(nvram value ECLK_SEL & 0x1<<0x1)|0x1*/
    hciCommand.parms[5] = 0x00;
    hciCommand.parms[6] = 0x00;
    hciCommand.parms[7] = 0x00;
...
static BtStatus GORMcmd_HCC_Set_TX_Power_Offset(void)
{
    ...
    hciCommand.parms[0] = btinit->bt_conf.fields.TxPWOffset[0];
    hciCommand.parms[1] = btinit->bt_conf.fields.TxPWOffset[1];
    hciCommand.parms[2] = btinit->bt_conf.fields.TxPWOffset[2];
